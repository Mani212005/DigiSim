...
export function CommandPaletteModal({
  ...
  const allCommands = useMemo<CommandItem[]>(() => {
    const commands: CommandItem[] = [
      ...
      {
        id: 'comp-gates-in-library',
        title: 'Gates live in My Library (transistor cells)',
        category: 'Components',
        description: 'Transistor-first: NOT/NAND/NOR/AND/OR/XOR are seeded transistor-built cells under My Library, not primitives',
        keywords: 'and or not nand nor xor xnor gate library standard cell transistor cmos',
        onSelect: () => onAddComponent('nmos', 'NMOS', { techNode: activeTechNode }),
      },
      {
        id: 'comp-subckt',
      ...
      {
        id: 'comp-capacitor',
        title: 'Silicon Capacitor',
        category: 'Components',
        description: 'Passive Integrated Capacitor (10pF Default)',
        keywords: 'capacitor cap c farad filter passive analog timing silicon',
        onSelect: () => onAddComponent('capacitor', 'Capacitor', { param: 10 }),
      },
      {
        id: 'comp-inductor',
        title: 'Integrated Inductor',
        category: 'Components',
        description: 'On-chip Spiral Inductor (100nH Default)',
        keywords: 'inductor ind l henry choke rf passive analog',
        onSelect: () => onAddComponent('inductor', 'Inductor', { param: 100 }),
      },
      {
        id: 'comp-bjt-npn',
        title: 'NPN BJT Transistor',
        category: 'Components',
        description: 'Bipolar Junction NPN Transistor (β=100)',
        keywords: 'bjt npn transistor bipolar current mirror bandgap',
        onSelect: () => onAddComponent('bjtNpn', 'NPN BJT', { param: 100 }),
      },
      {
        id: 'comp-bjt-pnp',
        title: 'PNP BJT Transistor',
        category: 'Components',
        description: 'Bipolar Junction PNP Transistor (β=80)',
        keywords: 'bjt pnp transistor bipolar current mirror analog',
        onSelect: () => onAddComponent('bjtPnp', 'PNP BJT', { param: 80 }),
      },
      {
        id: 'comp-clock',
        title: 'Clock Pulse Generator',
        category: 'Components',
        description: 'Digital Square Wave Clock Source (10 MHz Default)',
        keywords: 'clock clk pulse oscillator square wave generator input mcu frequency',
        onSelect: () => onAddComponent('clockSource', 'Clock', { param: 10 }),
      },
      {
        id: 'comp-vsource',
      ...
      {
        id: 'pdk-350nm',
        title: 'Switch to 350nm CMOS',
        category: 'PDK Process Nodes',
        description: `Set active process kit to BSIM3v3 350nm CMOS (Vdd=3.3V)${activeTechNode === '350nm' ? ' • [CURRENT]' : ''}`,
        keywords: 'switch pdk 350nm 350 360nm cmos bsim3 process node technology',
        onSelect: () => onSwitchPDK('350nm'),
      },
      {
        id: 'pdk-180nm',
      ...
      {
        id: 'pdk-45nm',
        title: 'Switch to 45nm High-K CMOS',
        category: 'PDK Process Nodes',
        description: `Set active process kit to BSIM4 45nm High-K Metal Gate (Vdd=1.0V)${activeTechNode === '45nm' ? ' • [CURRENT]' : ''}`,
        keywords: 'switch pdk 45nm 45 high-k cmos process node technology',
        onSelect: () => onSwitchPDK('45nm'),
      },
      {
        id: 'pdk-28nm',
